...
static const int64 nTargetTimespan =  1 * 24 * 60 * 60; // TestCoin: 1 days (difficulty re-target)
static const int64 nTargetSpacing = 30; // TestCoin: 30 seconds (time between blocks)
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa5c4858b0b29bb291dc3d108b65f67e7738bebcd2e04225c4c66ccb1e476b6e1");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Started on 2nd December 2013";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x12a61dbfd621cf3e9a5083678c412ad7ed15a11825844fc249e796136f4a36d3"));
